...
import cn.puhy.mymvc.controller.MyController;
...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        MyController myController = (MyController) context.getInstanceMaps().get("/" + className);
        try {
            Object o = method.invoke(myController, req, resp);
    ...
    class Context {
        ...
        private Map<String, Object> twoMaps = new HashMap<>();
        //url跟方法的一个映射关系 Controller的requestMapping的url 对应的method
        //insert->insert方法
        private Map<String, Method> threeMaps = new HashMap<>();

        Map<String, Method> getHandlerMaps() {
            return threeMaps;
        }

        Map<String, Object> getInstanceMaps() {
            return twoMaps;
        }
